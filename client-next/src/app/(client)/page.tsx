  ...
  return (
    <div className="bg-white dark:bg-[#050a12] text-slate-900 dark:text-white min-h-screen selection:bg-primary-500/30 transition-colors duration-500">
      <main className="flex flex-col items-center overflow-x-hidden">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center px-6 max-w-7xl w-full">
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20 w-full py-20">
            <div className="flex-[1.2] text-center md:text-left space-y-10">
