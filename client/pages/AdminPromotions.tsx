        ...
        <div className="max-w-7xl mx-auto pb-12">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 mb-6 flex flex-wrap items-center justify-between gap-4">
                <div className="flex-1 min-w-[300px] relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none text-sm"
                    />
                </div>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1.5 text-sm focus:ring-2 focus:ring-indigo-500 outline-none"
                        >
            ...
            {showScraperModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-700 animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-6 flex gap-4 border-b border-slate-100 dark:border-slate-700">
                            <input
                                type="text"
                                value={scrapeUrl}
                            ...
                            <button
                                ...
                                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/20 flex items-center gap-2"
                            >
                                {isScraping ? (
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex flex-col flex-1 min-w-0">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            ...
                                                            <span className="text-[10px] text-green-600 font-bold">{res.discountRate || 'Khám phá'}</span>
                                                        </div>
                                                        <div className="flex flex-col gap-0.5 mt-1">
                                                            <p className="text-[10px] text-slate-400">Bắt đầu: {formatDate(res.startDate)}</p>
                                                            <p className="text-[10px] text-slate-400">Kết thúc: {formatDate(res.validUntil)}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="border-t border-slate-100 dark:border-slate-700 pt-2">
                                                    <p className="text-[11px] text-slate-500 dark:text-slate-400 line-clamp-3 leading-relaxed opacity-80 italic">
                                                        {res.description?.replace(/<[^>]*>/g, '').substring(0, 150)}...
                                                    </p>
                                                </div>
                                            </div>
                                        ))}
