    ...
    return (
      <>
        ...
        <div className="pt-40 text-center">
          ...
          <button onClick={() => navigate(-1)} className="mt-4 text-primary-500 font-bold">Quay lại</button>
        </div>
      </>
    );
  }
            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#18181b] p-8 shadow-sm">
                ...
                <div className="mt-8 border-t border-slate-100 dark:border-slate-800 pt-6 flex justify-between items-center text-right">
                  <span className="text-lg font-bold text-slate-900 dark:text-slate-50">Tổng tiền tích lũy một năm:</span>
              ...
              {/* Benefits Section */}
              <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#18181b] p-8 shadow-sm">
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-6">Đặc Quyền Nổi Bật</h3>
